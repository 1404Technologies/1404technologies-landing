...
export const features = [
  {
    ...
    description:
      "HQ in London with subsidiaries in the U.S. and Nigeria. U.S./UK client liaisons with globally-trained, locally-operating teams.",
  },
  {
    iconName: "bolt",
    title: "AI-Powered Monitoring",
    description:
      "Proactive, AI-driven IT monitoring that identifies and resolves issues before they impact your business operations.",
  },
  {
    iconName: "shield",
  ...
  },
  {
    ...
    description:
      "Microsoft & AWS certified engineers delivering industry-leading 99.5% resolution rates with custom SLAs.",
  },
  {
    iconName: "card",
    title: "Built-in Compliance",
    description:
      "HIPAA, GDPR, ISO 27001, and SOC 2 Type II embedded across all services — not bolted on after the fact.",
  },
  {
    iconName: "chart",
    title: "Rapid Scalability",
    description:
      "Flexible, scalable teams that grow with your business — from 5 users to enterprise scale in weeks, not months.",
  },
];
...
export const services = [
  {
    ...
    description:
      "24/7 support, infrastructure management, backup and disaster recovery — all under a single SLA.",
    highlights: ["Help Desk & End-user support", "IT Infrastructure Management", "Backup & Disaster Recovery"],
    differentiators: ["Microsoft & AWS certified engineers", "AI-powered proactive monitoring", "Custom SLAs"],
  ...
  },
  {
    ...
    highlights: ["Managed SOC (24/7)", "Endpoint 360 Security", "Extended Detection & Response (XDR)", "Penetration Testing"],
    differentiators: ["Zero Trust architecture", "HIPAA, PCI-DSS, GDPR, SOC 2 built-in", "Real-time threat intelligence"],
  ...
  },
  {
    ...
    highlights: ["Virtual & Inbound Call Centre", "Overflow Call Handling", "BPO Call Centre"],
    differentiators: ["Omnichannel support", "Real-time KPI dashboards", "Cultural alignment with UK/U.S. expectations"],
  ...
  },
  {
    ...
    highlights: ["Custom application development", "Solution recommendations", "Ongoing support & maintenance"],
...
export const discounts = [
  ...
  "Volume discounts for 50+ users or endpoints",
